CREATE OR REPLACE FUNCTION COPY_SECURITY_FROM_OTHER_STUDY(studyid      CHARACTER VARYING, studyidfrom CHARACTER VARYING,
...
BEGIN
  ...
  procedureName := 'COPY_SECURITY_FROM_OTHER_STUDY';
...
ALTER FUNCTION COPY_SECURITY_FROM_OTHER_STUDY( CHARACTER VARYING, CHARACTER VARYING, NUMERIC )
OWNER TO postgres;
