...
SECURITY DEFINER
COST 100;
ALTER FUNCTION i2b2_delete_all_nodes( CHARACTER VARYING, NUMERIC ) SET search_path = tm_cz, i2b2demodata, i2b2metadata, pg_temp;

ALTER FUNCTION i2b2_delete_all_nodes( CHARACTER VARYING, NUMERIC )
OWNER TO tm_cz;
GRANT EXECUTE ON FUNCTION i2b2_delete_all_nodes(CHARACTER VARYING, NUMERIC) TO tm_cz;
REVOKE ALL ON FUNCTION i2b2_delete_all_nodes(CHARACTER VARYING, NUMERIC) FROM PUBLIC;
