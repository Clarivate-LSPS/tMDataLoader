-- Function: i2b2_load_annotation_deapp(numeric)

-- DROP FUNCTION i2b2_load_annotation_deapp(numeric);

CREATE OR REPLACE FUNCTION i2b2_load_annotation_deapp(currentjobid numeric DEFAULT (-1))
  RETURNS numeric AS
  $BODY$
/*************************************************************************
