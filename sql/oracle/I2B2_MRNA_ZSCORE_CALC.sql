...
--	truncate tmp tables
	...
	execute immediate('truncate table "&TM_WZ_SCHEMA".wt_subject_microarray_logs');
	execute immediate('truncate table "&TM_WZ_SCHEMA".wt_subject_microarray_calcs');
	execute immediate('truncate table "&TM_WZ_SCHEMA".wt_subject_microarray_med');
...
--		end if;
	...
	execute immediate('create index "&TM_WZ_SCHEMA".wt_subject_mrna_logs_i1 on "&TM_WZ_SCHEMA".wt_subject_microarray_logs (trial_name, probeset_id) nologging  tablespace "INDX"');
	stepCt := stepCt + 1;
...
--	calculate mean_intensity, median_intensity, and stddev_intensity per experiment, probe
	...
	execute immediate('create index "&TM_WZ_SCHEMA".wt_subject_mrna_calcs_i1 on "&TM_WZ_SCHEMA".wt_subject_microarray_calcs (trial_name, probeset_id) nologging tablespace "INDX"');
	stepCt := stepCt + 1;
