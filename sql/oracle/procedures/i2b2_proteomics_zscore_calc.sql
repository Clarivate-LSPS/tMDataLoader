--
-- Type: PROCEDURE; Owner: TM_DATALOADER; Name: I2B2_PROTEOMICS_ZSCORE_CALC
--
...
--		end if;
	...
	stepCt := stepCt + 1;
	cz_write_audit(jobId,databaseName,procedureName,'Create index on TM_DATALOADER WT_SUBJECT_PROTEOMICS_LOGS_I1',0,stepCt,'Done');
...
--	calculate mean_intensity, median_intensity, and stddev_intensity per experiment, probe
	...
	group by d.trial_name 
			,d.probeset_id;
	stepCt := stepCt + 1;
	cz_write_audit(jobId,databaseName,procedureName,'Calculate intensities for trial in TM_DATALOADER WT_SUBJECT_PROTEOMICS_CALCS',SQL%ROWCOUNT,stepCt,'Done');
	...
	--stepCt := stepCt + 1;
	--cz_write_audit(jobId,databaseName,procedureName,'Create index on TM_DATALOADER WT_SUBJECT_PROTEOMICS_CALCS',0,stepCt,'Done');
...
--	,sample_cd
	...
	stepCt := stepCt + 1;
	cz_write_audit(jobId,databaseName,procedureName,'Calculate Z-Score for trial in TM_DATALOADER WT_SUBJECT_PROTEOMICS_MED',SQL%ROWCOUNT,stepCt,'Done');
