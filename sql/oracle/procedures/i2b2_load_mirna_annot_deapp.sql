--
-- Type: PROCEDURE; Owner: TM_DATALOADER; Name: I2B2_LOAD_MIRNA_ANNOT_DEAPP
--
  CREATE OR REPLACE PROCEDURE "TM_DATALOADER"."I2B2_LOAD_MIRNA_ANNOT_DEAPP" 
(
...
*/
  ...
  ,d.gpl_id
	...
	*/
	...
	from tm_dataloader.lt_qpcr_mirna_annotation t
	where not exists
