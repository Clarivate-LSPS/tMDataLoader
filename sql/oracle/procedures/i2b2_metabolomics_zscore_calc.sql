--
-- Type: PROCEDURE; Owner: TM_DATALOADER; Name: I2B2_METABOLOMICS_ZSCORE_CALC
--
  CREATE OR REPLACE PROCEDURE "TM_DATALOADER"."I2B2_METABOLOMICS_ZSCORE_CALC" 
(
  trial_id VARCHAR2
 ,run_type varchar2 := 'L'
...
--	truncate tmp tables
	...
	execute immediate('truncate table tm_dataloader.WT_SUBJECT_METABOLOMICS_LOGS');
	execute immediate('truncate table tm_dataloader.WT_SUBJECT_METABOLOMICS_CALCS');
	execute immediate('truncate table tm_dataloader.WT_SUBJECT_METABOLOMICS_MED');
