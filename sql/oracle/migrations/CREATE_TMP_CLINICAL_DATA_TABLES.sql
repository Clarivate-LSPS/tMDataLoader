...
CREATE TABLE TM_DATALOADER.wt_trial_nodes AS SELECT * FROM tm_wz.wt_trial_nodes NOLOGGING;
...
ALTER TABLE TM_DATALOADER.wt_trial_nodes MODIFY category_cd VARCHAR2(250);
