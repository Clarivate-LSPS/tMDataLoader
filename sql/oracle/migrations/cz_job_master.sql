--
-- Type: TABLE; Owner: TM_DATALOADER; Name: CZ_JOB_MASTER
--
 CREATE TABLE "TM_DATALOADER"."CZ_JOB_MASTER" 
...
--
CREATE SEQUENCE  "TM_DATALOADER"."SEQ_CZ_JOB_MASTER"  MINVALUE 1 MAXVALUE 999999999999999999999999 INCREMENT BY 1 START WITH 18288 CACHE 2 NOORDER  NOCYCLE ;

--
-- Type: TRIGGER; Owner: TM_CZ; Name: TRG_CZ_JOB_ID
--
  CREATE OR REPLACE TRIGGER "TM_DATALOADER"."TRG_CZ_JOB_ID" 
  before insert on TM_DATALOADER.CZ_JOB_MASTER    for each row
  begin
    if inserting then
...
/
ALTER TRIGGER "TM_DATALOADER"."TRG_CZ_JOB_ID" ENABLE;
